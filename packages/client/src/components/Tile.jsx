        ...
        <div className="p-col-12 p-md-6 p-lg-3">
          <div className="p-grid card colorbox colorbox-2">
            ...
            <div className="p-col-8">
              ...
              <span className="colorbox-count">{tile?.totalOverall}</span>
            </div>
          </div>
        </div>
        <div className="p-col-12 p-md-6 p-lg-3">
          <div className="p-grid card colorbox colorbox-1">
            ...
            <div className="p-col-8">
              ...
              <span className="colorbox-count">{tile?.totalMigrated}</span>
            </div>
          </div>
        </div>
        <div className="p-col-12 p-md-6 p-lg-3">
          <div className="p-grid card colorbox colorbox-3">
            ...
            <div className="p-col-8">
              ...
              <span className="colorbox-count">{tile?.totalNonMigrated}</span>
            </div>
          </div>
        </div>
        <div className="p-col-12 p-md-6 p-lg-3">
          <div className="p-grid card colorbox colorbox-4">
            ...
            <div className="p-col-8">
              ...
              <span className="colorbox-count">
                {tile?.migrationProgress.toFixed(1)} %
              </span>
            </div>
          </div>
        </div>
